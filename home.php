...
if ($_SESSION['isAdmin'] == Usuario::USUARIO) {
    ...
    <div class="bk line">
        <legend style="padding-bottom:10px; margin-bottom: 50px">Minhas ocorrências&nbsp;&nbsp;&nbsp;<span
                    class="glyphicon glyphicon-map-marker"></span></legend>
        ...
        <form>
            <!--
            <table class="table-bordered" width="100%" style="margin-bottom: 50px; ">
                <tr>
                    <td class="tdPers col-lg-2 text-right" style="border: none;">
                        <label>Protocolo</label>
                    </td>
                    <td class="tdPers col-lg-2">
                        <input type="text" name="protocolo" class="form-control" value="201659715"
                               placeholder="Digite aqui o número do protocolo">
                    </td>
                    <td class="tdPers col-lg-1">
                        <a target="_blank" href="pesquisar-ocorrencia.php?pid=<?php ?>">
                            <button type="submit" name="<?php echo NovaOcorrenciaController::BTN_SEARCH ?>" class="btn btn-primary" style="float: left">
                                <span class="glyphicon glyphicon-search"></span>
                            </button>
                        </a>
                    </td>
                    <td class="tdPers col-lg-7">
                        <a href="nova-ocorrenca.php">
                            <button class="btn btn-primary" style="float: right">Nova ocorrencia</button>
                        </a>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-striped table-hover" width="100%">
                ...
                <?php $uid = $_SESSION['id'];
                $ocorrencias = NovaOcorrenciaController::getFaultsByUserId($uid);
                foreach ($ocorrencias as $ocorrencia) {
                    ...
                    <tr>
                        ...
                        <td class="tdPers col-lg-1">
                            <a target="_blank" href="detalhes-ocorrencia.php?oid=<?php echo $ocorrencia['id'] ?>&uid=<?php echo $uid ?>">
                                <button class="btn btn-success"><span class="glyphicon glyphicon-info-sign"></span></button>
                            </a>
                        </td>
                        <td class="tdPers col-lg-1">
                            <a target="_blank" href="remover-ocorrencia.php?oid=<?php echo $ocorrencia['id'] ?>&uid=<?php echo $uid ?>">
